 ...
 */
public class SimpleSignatureV3Sample {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length < 4 || args.length > 5) {
			System.out.println("usage:   java SimpleSignatureV3Sample [-hsm|-hsmAuth] email-id message sendername output-filename");
			System.out.println("example: java SimpleSignatureV3Sample user@gmail.com \"hello world\" \"me\" signature.p7m");
			System.exit(1);
		}
