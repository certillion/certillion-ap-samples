 ...
 * 
 */
@WebServiceClient(name = "SignatureService", targetNamespace = "http://esec.com.br/mss/ap", wsdlLocation = "http://labs.certillion.com/mss/serviceAp_prod.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://labs.certillion.com/mss/serviceAp_prod.wsdl");
