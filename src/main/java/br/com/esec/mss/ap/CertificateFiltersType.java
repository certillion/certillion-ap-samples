...
/**
 * <p>
 * Java class for CertificateFiltersType complex type.
 * 
 * <p>
...
@XmlType(name = "CertificateFiltersType", propOrder = { "trustChainOrOwnerCertificateOrAlgorithm" })
public class CertificateFiltersType {

	@XmlElements({ @XmlElement(name = "OwnerCertificate", type = OwnerFilterType.class),
	 ...
	 * <CODE>set</CODE> method for the trustChainOrOwnerCertificateOrAlgorithm
	 * property.
	 * 
	 * <p>
	 ...
	 * {@link OwnerFilterType } {@link ForceHardwareFilterType }
	 * {@link AlgorithmFilterType } {@link TrustChainFilterType }
	 * 
	 * 
	 */
